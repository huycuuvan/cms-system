            ...
            <div class="col-md-8">
                ...
                if (isset($_GET['p_id'])) {
                    ...
                    while ($row = mysqli_fetch_array($select_all_post_query)) {
                        ...
                        $view_count_query = mysqli_query($conn, $query);
                ...
                <div class="well">
                    ...
                    <form action="" method="post" role="form">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="comment_author" type="text" name="comment_author" id="">
                        </div>
                        <div class="form-group">
                            <label for="Email">Email</label>

                            <input class="form-control" name="comment_email" type="text" name="comment_email" id="">
                        </div>
